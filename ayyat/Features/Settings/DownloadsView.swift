...
struct DownloadsView: View {
    ...
    private var audioCache: WordAudioCache { SharedWordAudioCache.shared }
            ...
            Section {
                if isDownloadingAll {
                    ...
                    Button {
                        ...
                        .foregroundStyle(audioCache.downloadedSurahs.count == 114 ? AyyatColors.mastered : AyyatColors.primary)
                    }
                ...
                ForEach(quranStore.chapters) { chapter in
                    HStack {
                        ...
                        Image(systemName: audioCache.isCached(surah: chapter.id) ? "checkmark.circle.fill" : "circle")
                            .foregroundStyle(audioCache.isCached(surah: chapter.id) ? AyyatColors.mastered : AyyatColors.unseen)
                            .font(.system(size: 16))
